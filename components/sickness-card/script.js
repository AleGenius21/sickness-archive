...
/**
 * Crea una card per certificati di malattia
 * @param {Object} data - Oggetto contenente i dati del certificato
...
function createSicknessCard(data) {
	// Creazione elemento card principale
	const row = document.createElement('div');
	row.className = 'sickness-card ms-1 me-3 mt-1';
	...
	statusIcon.className = 'sickness-card-status-icon';
